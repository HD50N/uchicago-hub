    ...
    <main className="w-full h-screen flex items-center justify-center">
      <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button
            ...
            className={`w-full px-4 py-2 font-medium rounded-lg text-white ${
              isSigningIn ? 'bg-gray-300 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 transition duration-300'
            }`}
          >
        ...
        <div className="flex items-center w-full">
          ...
          <div className="px-2 text-sm font-bold">OR</div>
          <div className="flex-grow border-b border-gray-300"></div>
        </div>
        <button
          disabled={isSigningIn}
          onClick={onGoogleSignIn}
          className={`w-full flex items-center justify-center gap-3 py-2.5 border rounded-lg text-sm font-medium ${
