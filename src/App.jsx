...
function App() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-50">
            <header className="bg-[#800000] shadow py-6 px-8 flex justify-between items-center z-50 relative">
            ...
            <footer className="bg-[#800000] py-4 text-center text-sm text-white z-50 relative">
